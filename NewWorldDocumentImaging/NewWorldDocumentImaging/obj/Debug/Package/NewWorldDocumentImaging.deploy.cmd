...
set _DeploySetParametersFile=%RootPath%NewWorldDocumentImaging.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%NewWorldDocumentImaging.zip" (
echo "%RootPath%NewWorldDocumentImaging.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewWorldDocumentImaging.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewWorldDocumentImaging.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewWorldDocumentImaging.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%NewWorldDocumentImaging.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewWorldDocumentImaging.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%NewWorldDocumentImaging.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%NewWorldDocumentImaging.deploy-readme.txt" (
...
start notepad "%RootPath%NewWorldDocumentImaging.deploy-readme.txt"
)
echo =========================================================
goto :eof
