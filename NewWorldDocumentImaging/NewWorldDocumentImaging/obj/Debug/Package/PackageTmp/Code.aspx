<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Code.aspx.vb" Inherits="NewWorldDocumentImaging._Code" %>
...
<body>
    ...
    <div>
        ...
        <p class="style1">
            <asp:Label ID="lblCodeNumberText" runat="server" Text="Case Number: " 
                Font-Names="Calibri"></asp:Label>
            <asp:Label ID="lblCode" runat="server" Text="Label" Font-Names="Calibri"></asp:Label>
            <br />
        </p>
        <p class="style1">
        ...
        <p class="style1">
            <asp:Button ID="btnCloseCode" runat="server" Text="Close" Visible="False" 
        ...
        <p class="style1">
            <table>
                <tr>
                    ...
                    <td class="style3">
            <asp:Button ID="btnSearchCode" runat="server" Text="Search by Case Number" 
                ...
                <tr>
                    ...
                    <td class="style3">
            <asp:Button ID="btnScanCode" runat="server" Text="Scan New Document" Width="225px" 
